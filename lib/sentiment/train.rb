...
arff_file = File.dirname(__FILE__) + "/../../data/sentiment2.arff"
...
# evaluation.evaluate_model(classifier, test)

evaluation.crossValidateModel(classifier, train, 10, java.util.Random.new(1))

puts evaluation.to_summary_string("\nResults\n======\n", false)
# puts "Correct:"
# puts evaluation.correct
# puts "% Correct:"
# puts evaluation.pct_correct
# puts "Correlation Coefficient:"
# puts evaluation.correlation_coefficient
# puts "Mean Absolute Error:"
# puts evaluation.mean_absolute_error

# puts train.instance(0).to_s
...
if evaluation.pct_correct.to_f < 68.0
  # Not good enough, lets not include this one, also delete the old model
  puts "Not good enough, deleting #{model_path}"
